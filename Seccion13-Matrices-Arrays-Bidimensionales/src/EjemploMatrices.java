public class EjemploMatrices {
    public static void main(String[] args) {
        ...
        // numeros[0][4] = 5; Lanzaría un error indicando que estamos fuera de los límites del array
        ...
        System.out.println("número de columnas: " + numeros[0].length); //nos vale cualquiera:
